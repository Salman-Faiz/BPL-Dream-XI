...
const SubscribeUs = () => {
    return (
        <div className="subscribe-bg bg-cover border text-center space-y-4 flex flex-col justify-center items-center mx-20 rounded-xl py-16 my-10">
        ...
        <div className=" flex gap-2">
            <input type="text" placeholder="Enter Your Email" className="border py-3 rounded-md px-2 text-lg w-full flex-1"/>
